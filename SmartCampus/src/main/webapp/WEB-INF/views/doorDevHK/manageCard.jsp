                ...
                <div style=" height: 400px;float: left;margin-left: 30px;margin-bottom: 5px; border-width: 1px; border-style: solid;border-color: #e6e6e6;">
                    ...
                    <div>
                        <div class="table_1" style="float: left;margin-left: 5px;margin-bottom: 5px">
                            <table id="candidatesTable" lay-filter="demo1">候选人员</table>
                        </div>

                        <div class="button_transfer1"  style="float: left;padding: 14px; padding-top: 130px;margin-left: 20px" >
                            <div><button id="btnStaffSelect" type="button" class="layui-btn layui-btn-sm " lay-event="transfer1"><i class="layui-icon">&#xe65b;</i></button></div><br>
                            <div><button id="btnStaffCancel" type="button" class="layui-btn layui-btn-sm layui-btn-danger" ><i class="layui-icon">&#xe65a;</i></button></div>
                        </div>

                        <div class="table_2" style="float: left;margin-left: 20px;margin-right: 5px">
                            <table id="selectedStaffTable" lay-filter="demo2">已选人员</table>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div style=" height: 400px;float: left;margin-left: 30px;margin-bottom: 5px; border-width: 1px; border-style: solid;border-color: #e6e6e6;">
                    <div style="padding: 5px;">
                        ...
                        <div style="margin-top: 5px;">
                            <label >设备名称/IP:</label>
                            <div class="layui-inline">
                                <input type="text" id="dev" placeholder="设备名称/IP" style="width: 100px;height: 30px;margin-right:10px;margin-left:10px;">
                            </div>
                    ...
                    <div>
                        <div style="float: left;margin-left: 5px;margin-bottom: 5px">
                            <table id="CandidateDoorTable" lay-filter="demo1">候选门</table>
                        </div>

                        <div class="button_transfer1"  style="float: left;padding: 14px; padding-top: 130px;margin-left: 20px" >

                            <div><button id="btnDoorSelect" type="button" class="layui-btn layui-btn-sm " lay-event="transfer1"><i class="layui-icon">&#xe65b;</i></button></div><br>
                            <div><button id="btnDoorCancel" type="button" class="layui-btn layui-btn-sm layui-btn-danger" ><i class="layui-icon">&#xe65a;</i></button></div>
                        </div>

                        <div style="float: left;margin-left: 20px;margin-right: 5px">
                            <table id="selectedDoorTable" lay-filter="demo2">已选门</table>
                        </div>
                    </div>
...
<script>
    ...
    function queryDoor() {
        var dname = $('#dev').val();
        var dip = $('#dev').val();
        table.reload('CandidateDoorTable', {
            url: 'queryDoorTree'
            ,where: {
                dname:dname,
                dip:dip,
    ...
    layui.use(['table', 'element', 'transfer', 'util', 'layer', 'form'], function () {
        ...
        function reloadTb2(){
            table.reload('selectedStaffTable');
        }

        table.render({
            elem: '#candidatesTable'
            , height: '300'
            , width:'515'
        ...
        table.render({
            ...
            , cols: [[ //表头
                {type: 'checkbox', fixed: 'left'},
                {type: 'numbers', title: '序号', fixed: 100,event:'row'}
                , {field: 'dname', title: '设备名称', width : 211,align : 'center'}
                , {field: 'dip', title: '设备IP', width : 211,align : 'center'}
            ]]
            ,page:true
            ,limits:[10,20,50,100]
            ,limit:20
        ...
        $('#btnStaffSelect').click(function (){
            var checkStatus = table.checkStatus('candidatesTable')  //以id为索引
        ...
        $('#btnStaffCancel').click(function (){
            var checkStatus = table.checkStatus('selectedStaffTable')
        ...
        $('#btnDoorSelect').click(function (){
            var checkStatus = table.checkStatus('CandidateDoorTable')  //以id为索引
                ,data = checkStatus.data; //获取选中行的数据 ,Object数组类型
        ...
        $('#btnDoorCancel').click(function (){
            var checkStatus = table.checkStatus('selectedDoorTable')
                ,data = checkStatus.data; //获取选中行的数据 ,数组类型
            data.forEach(function(res){
