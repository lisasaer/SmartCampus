        ...
        <div class=""style="padding-right: 20px;float: right">
            ...
            <div class="layui-input-inline" style="width: 190px;">
                <select id="selType" name="devType" lay-filter="test">
                    <option value="IPC"  <c:if test="${'IPC'==deviceList.get(0).devType}"> selected="selected" </c:if>>IPC</option>
                    <option value="NVR"  <c:if test="${'NVR'==deviceList.get(0).devType}"> selected="selected" </c:if>>NVR</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item"style="float: left;">
            ...
            <div class="layui-input-inline">
                <input type="text" name="ip" lay-verify="required" placeholder="请输入设备IP"
                       autocomplete="off" class="layui-input" readonly="readonly"  style="background-color: #d7d7d7">
            </div>
        </div>
        <div class=""style="padding-right: 20px;float: right">
            ...
            <div class="layui-input-inline" style="width: 190px;">
                <input type="text" name="netMask" lay-verify="required" placeholder="请输入子网掩码"
                       autocomplete="off" <%--value="255.255.255.0" --%>class="layui-input" readonly="readonly"  style="background-color: #d7d7d7">
            </div>
        </div>
        <div class="layui-form-item"style="float: left;">
            ...
            <div class="layui-input-inline">
                <input type="text" name="gateWay" lay-verify="required" placeholder="请输入网关"
                       autocomplete="off" class="layui-input" <%--value="192.168.0.1"--%> readonly="readonly"  style="background-color: #d7d7d7">
            </div>
        </div>
        <div class=""style="padding-right: 20px;float: right">
            ...
            <div class="layui-input-inline" style="width: 190px;">
                <input type="text" name="port" lay-verify="required" placeholder="请输入端口" autocomplete="off"
                       class="layui-input" <%--value="8000"--%> readonly="readonly"  style="background-color: #d7d7d7">
            </div>
        </div>
        <div class="layui-form-item"style="float: left;">
