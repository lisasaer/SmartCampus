    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body" style="bottom: 0px;margin-left: 25px;margin-top: 4px;padding:15px;background-color: #e8ebee">
            <div style="margin: 200px 700px">
                <input class="layui-input" type="text" id="noiseAlarmValue" placeholder="请输入噪音报警阈值" style="width: 170px;height: 32px;">
                <button id="setNoiseAlarmValue" class="layui-btn layui-btn-normal layui-btn-radius layui-btn-sm" style="margin:5px 40px;">设置</button>
            </div>
        </div>
    </div>
...
<script>
    ...
    $('#setNoiseAlarmValue').click(function () {
        var noiseAlarmValue = $('#noiseAlarmValue').val()
        console.log(noiseAlarmValue)
        $.post('setNoiseAlarmValue',{noiseAlarmValue:noiseAlarmValue},function (res) {
            console.log(res)
            if (res){
                layer.msg("设置成功")
            } else {
